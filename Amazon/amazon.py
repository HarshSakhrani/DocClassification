...
root="/root/DocClassification/Amazon/"
...
dfTrainOriginal=pd.read_csv("/content/amazon_review_full_csv/train.csv",header=None)
dfTest=pd.read_csv("/content/amazon_review_full_csv/test.csv",header=None)

dfTrainOriginal=dfTrainOriginal.drop([1],axis=1)
dfTest=dfTest.drop([1],axis=1)
...
plt.ylabel('Loss')
plt.legend()
plt.savefig('AmazonLoss_4.png', bbox_inches='tight')
plt.close()
#plt.show()
...
plt.ylabel('Accuracy')
plt.legend()
plt.savefig('AmazonAcc_4.png', bbox_inches='tight')
plt.close()
