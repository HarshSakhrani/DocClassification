...
plt.ylabel('Loss')
plt.legend()
plt.savefig('bert_trainable_docClassification_agnews_loss.png', bbox_inches='tight')
plt.close()
#plt.show()
...
plt.ylabel('Accuracy')
plt.legend()
plt.savefig('bert_trainable_docClassification_agnews_acc.png', bbox_inches='tight')
plt.close()
...
f=open("bert_trainable_docClassification_agnews_Results.txt","a")
f.write(str(cm))
f.close()
