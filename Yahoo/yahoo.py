...
root="/root/DocClassification/Yahoo/"
...
dfTrainOriginal=pd.read_csv("/root/DocClassification/Yahoo/yahoo_answers_csv/train.csv",header=None)
dfTest=pd.read_csv("/root/DocClassification/Yahoo/yahoo_answers_csv/test.csv",header=None)

dfTrainOriginal=dfTrainOriginal.drop([1,2],axis=1)
dfTest=dfTest.drop([1,2],axis=1)

dfTrainOriginal=dfTrainOriginal[dfTrainOriginal[3].notna()]
dfTest=dfTest[dfTest[3].notna()]
...
dfTrain=dfTrain[0:1237872]
dfTest=dfTest[0:58960]
dfVal=dfVal[0:137536]
...
plt.ylabel('Loss')
plt.legend()
plt.savefig('YahooLoss_4.png', bbox_inches='tight')
plt.close()
#plt.show()
...
plt.ylabel('Accuracy')
plt.legend()
plt.savefig('YahooAcc_4.png', bbox_inches='tight')
plt.close()
